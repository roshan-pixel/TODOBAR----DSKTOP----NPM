...
export const DynamicIsland: React.FC<DynamicIslandProps> = ({
  ...
  return (
    <div className="w-full flex justify-center pt-2.5 pb-1 relative z-50 pointer-events-auto select-none">
      <button
        type="button"
        onClick={onTap}
        className="group relative flex items-center justify-between px-3.5 h-[34px] rounded-full bg-black border border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(255,255,255,0.15)] transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
        style={{
          width: mode === 'idle' ? '126px' : '204px',
        }}
